...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1234567890123456789, "1234 56** **** ***6 789"),  # 19 цифр
        (1234567890, "1234 5678 90"),  # 10 цифр (минимум)
        (9999999999999999, "9999 99** **** 9999"),  # Все 9
    ],
)
def test_get_mask_card_number_valid(number: int, expected: str) -> None:
...
def test_get_mask_account_valid(number: int, expected: str) -> None:
